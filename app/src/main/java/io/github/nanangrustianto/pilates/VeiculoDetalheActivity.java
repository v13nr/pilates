                            ...
                            StringRequest stringRequest = new StringRequest(Request.Method.POST,
                                ...
                                public void onResponse(String response) {
                                    ...
                                    try{
                                        ...
                                        Toast.makeText(VeiculoDetalheActivity.this, "Terkendalan dengan service data..1", Toast.LENGTH_SHORT).show();
                                        e.printStackTrace();
                                        progressDialog.cancel();
...
//                        ehnovo.setText("Novo");
 ...
 //                       ehnovo.setText("Usado");
                    ...
                    Toast.makeText(VeiculoDetalheActivity.this, "Terkendalan dengan service data..3", Toast.LENGTH_SHORT).show();
                    e.printStackTrace();
                    progressDialog.cancel();
